...
# 
price = input(f"{my_name}, how much is {food} at your market in €?")
double_price = price*2 # careful here
print(f"Double price is {double_price}")
...
print(f"Sorry, real {price} doubled is {real_double_price}")
#
# i can type cast immediately
# i would use float instead of int if i want floating point numbers
