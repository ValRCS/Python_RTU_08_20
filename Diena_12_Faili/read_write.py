...
with open('frost.txt', encoding="utf-8") as f:  # create a file object
    ...
    filtered_lines = []
    for line in f:
        if needle in line: # we can do more complex logic here
...
file_path = Path("frost_cleaned_may5.txt")
...
with open('frost.txt', encoding="utf-8") as fin, open("frost_out_may5.txt", mode="w", encoding="utf-8") as fout:
