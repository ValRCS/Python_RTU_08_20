...
# relative_path = 'Diena_12_Faili/frost.txt'
...
file_path = Path("frost_cleaned_nov1.txt")
...
with open('frost.txt', encoding="utf-8") as fin, open("frost_out_nov1.txt", mode="w", encoding="utf-8") as fout:
