...
print('ValdisZ' in tel) # case sensitive so False
...
# print(tel)
popped_value = tel.pop("empty_string") # so we can get the value that was deleted
print(tel)
# # print(popped_value)
tel.pop("empty_string", "my_default")
...
tel.update({"Valdis":29000, "3": 500, "foo": 5454}) # so merging dictionaries
print(tel)
