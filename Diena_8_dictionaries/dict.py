...
print("Are actually same data structure in memory:", tel_dict is tel)
...
# # # # # # # tel['valdis'] = 2640
# # # # # # # print(tel)
tel['petēris'] = 2911  # any string can be key
# print(tel)
...
print(tel)
print(popped_value)
tel.pop("empty_string", "default")
tel.pop("no_such_key", "default") # we can use this to delete a key if it is not there
