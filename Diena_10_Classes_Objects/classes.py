...
# # # # # # #     # do not share lists, dictionaries other mutable structures in class properties
    def print_house_prop(self):  # self refers to concrete object
...
# my_house.build_house().build_house().build_house()  #possible because of return self
...
millhouse_garage.add_nails(100).simple_print().add_nails(100).simple_print()
