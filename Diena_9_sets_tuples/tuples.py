...
# my_tuple[4] += [1,2,3] # i can not write a new list in place of old list,
...
# print(new_tuple)
t = ()  # empty tuple only question where would you use it? One use to functiosn which need some sequence
print(t, type(t))
