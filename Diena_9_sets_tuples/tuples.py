...
my_tuple = ("Valdis", "programmer", 45, 200.8, [10, 20, 30], True, None, ('also_tuple', 5, True), {'food':'potatoes', 'drink':'kefir'})
print(my_tuple)
...
print(my_tuple[-1]['drink'], my_tuple[-1].get('drink')) # get also would work
print(my_tuple[4])
print(my_tuple[4][1])
print(my_tuple[-2][-2], my_tuple[-2][1])
...
# extended unpacking
head, second, *rest, tail = my_tuple # names you pick yourself
