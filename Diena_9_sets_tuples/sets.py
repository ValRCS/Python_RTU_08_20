...
print(new_set == food_item_set, new_set is food_item_set) # is checks if variables point to same memory structure
...
print(n8_9, n5_9.difference(n3_7)) # so - or difference work the same on sets
# # # # # # # # # # # simmetrical difference so values unique to either of the sets
n_sim = n3_7 ^ n5_9
print(n_sim, n3_7.symmetric_difference(n5_9))

print("Sets are disjoint", n3_4.isdisjoint(n8_9)) # are sets completely disjoint(different)
