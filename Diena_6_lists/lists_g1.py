...
new_list += ["Malējs", "Salīgais"] # shorthand for new_list = new_list + [new ]
...
print("Lists have equal values?",str_list == str_list_2) # check if lists containe equal values
...
print(beer_list)
beer_with_zh = [el for el in beer_list if "ž" in el]
print(beer_with_zh)
