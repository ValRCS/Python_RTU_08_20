...
print(my_list)
print(my_list[0])
my_list[1] = "Mr. 20"  # lists are mutable (unlike strings)
print(my_list[:3])
...
new_list = my_list + ["Kalējs", "Audējs"] # out of place addition
...
print(str_list_2)
print(str_list == str_list_2, str_list is str_list_2)
...
print(beer_list)
beer_list += ["Užavas alus"] # we create a list on demand - list literal
print(beer_list)
