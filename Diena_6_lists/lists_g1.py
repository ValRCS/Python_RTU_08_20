...
my_numbers = list(range(10)) # no 0 lidz 9
print(my_numbers)
print(my_numbers[::2])
...
squares = [n*n or 9000 for n in my_numbers] # we could utilie or for 0
print(squares)
...
print(beer_list.index("alus"))
# print(beer_list.find("Mālenīetis"))
